...
class Narrowphase {
   ...
   */
  ContactEquation createContactEquation (bodyA, bodyB, shapeA, shapeB){
   ...
   */
  FrictionEquation createFrictionEquation (bodyA, bodyB, shapeA, shapeB){
   ...
   * @return {FrictionEquation}
   */
  FrictionEquation createFrictionFromContact (c){
...
// Take the average N latest contact point on the plane.
  ...
  lineRectangle (
   ...
   setConvexToCapsuleShapeMiddle(convexShape, capsuleShape){
 ...
 */
pointInConvex(worldPoint,convexShape,convexOffset,convexAngle){
...
List pcoa_tmp1 = vec2.fromValues(0,0);
...
List fsa_tmp1 = vec2.fromValues(0,0)
...
List  gce_tmp1 = vec2.fromValues(0,0)
 ...
 */
num getClosestEdge (c,angle,axis,flip){
