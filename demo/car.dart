...
app= new WebGLRenderer((){
  ...
  // Add circle bump in the center
    ...
    p2.Body circleBody = new p2.Body({
  ...
  // Create chassis for our car
    p2.Body chassisBody = new p2.Body({
  ...
  // Revolutes lets the connected bodies rotate around a shared point.
    p2.RevoluteConstraint revoluteBack = new p2.RevoluteConstraint(chassisBody, wheelBody1, {
      localPivotA: [-0.5, -0.3],   // Where to hinge first wheel on the chassis
      localPivotB: [0, 0],
      collideConnected: false
  });
    p2.RevoluteConstraint revoluteFront = new p2.RevoluteConstraint(chassisBody, wheelBody2, {
